...
Create a `.env.local` file at the root of the project, and paste the API URL and the <LegacyApiKeys keyword='publishable' type='anon'/> key that you copied [earlier](#get-the-api-keys).
